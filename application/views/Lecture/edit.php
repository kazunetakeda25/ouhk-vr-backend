                        ...
                        <div class="col-12">
                            <div class="card">
                                <div class="card-content collapse show">
                                    <div class="card-body">
                                        <?= form_open_multipart(base_url() . 'lecture/edit/' . $data_lecture->id) ?>
                                        <div class="form-body">
                                            ...
                                            <div class="row">
                                                <div class="col-md-12">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" id="title" class="form-control" placeholder="Enter Lecture Title" name="title" value="<?= $data_lecture->title ?>">
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="form-group d-block" id="mp3_current_panel">
                                                <label for="mp3_current">Lecture MP3 File</label>
