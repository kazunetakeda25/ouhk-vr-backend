                                    ...
                                    <div class="card-body">
                                        ...
                                        <div class="form-body">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <textarea id="original_word" rows="5" class="form-control" name="original_word" placeholder="Enter Original Word"><?= $data_glossary->original_word ?></textarea>
                                            </div>
                                            <div class="form-group">
                                                <label for="translated_word">Translated Word</label>
                                                <textarea id="translated_word" rows="5" class="form-control" name="translated_word" placeholder="Enter Translated Word"><?= $data_glossary->translated_word ?></textarea>
                                            </div>
                                        </div>
