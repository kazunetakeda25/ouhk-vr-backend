                                            ...
                                            <div class="row">
                                                <div class="col-md-12">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" id="title" class="form-control" placeholder="Enter Learning Content Title" name="title" value="<?= $data_learning_content->title ?>">
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="form-group">
                                                <label for="data">Learning Content Data</label>
                                                <textarea id="data" rows="5" class="form-control" name="data" placeholder="Enter Learning Content Data"><?= $data_learning_content->data ?></textarea>
                                            </div>
                                        </div>
