    ...
    <div class="main-menu menu-fixed menu-light menu-accordion    menu-shadow " data-scroll-to-active="true" data-img="<?= base_url() ?>app-assets/images/backgrounds/02.jpg">
        ...
        <div class="main-menu-content">
            <ul class="navigation navigation-main" id="main-menu-navigation" data-menu="menu-navigation">
                ...
                <li class=" nav-item active"><a href="<?= base_url() ?>practice"><i class="fa fa-file"></i><span class="menu-title small" data-i18n="">Interpreting <br>Practice & Exercise</span></a>
                </li>
                        ...
                        <div class="col-12">
                            <div class="card">
                                <div class="card-content collapse show">
                                    <div class="card-body">
                                        <?= form_open_multipart(base_url() . 'practice/edit/' . $data_practice->id) ?>
                                        <div class="form-body">
                                            ...
                                            <div class="row">
                                                <div class="col-md-12">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" id="number" class="form-control" placeholder="Enter Interpreting Practice & Exercise Number" name="number" value="<?= $data_practice->number ?>">
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="row">
                                                <div class="col-md-12">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" id="title" class="form-control" placeholder="Enter Interpreting Practice & Exercise Title" name="title" value="<?= $data_practice->title ?>">
                                                    </div>
                                                </div>
                                            </div>
                                            <!-- Ex1. MP3 -->
