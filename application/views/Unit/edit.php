    ...
    <div class="main-menu menu-fixed menu-light menu-accordion    menu-shadow " data-scroll-to-active="true" data-img="<?= base_url() ?>app-assets/images/backgrounds/02.jpg">
        ...
        <div class="main-menu-content">
            <ul class="navigation navigation-main" id="main-menu-navigation" data-menu="menu-navigation">
                ...
                <?php } ?>
                <li class=" nav-item active"><a href="<?= base_url() ?>unit"><i class="fa fa-folder"></i><span class="menu-title" data-i18n="">Units</span></a>
                </li>
                                    ...
                                    <div class="card-body">
                                        ...
                                        <div class="form-body">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input type="text" id="number" class="form-control" placeholder="Enter Unit Number" name="number" value="<?= $data_unit->number ?>">
                                            </div>
                                            <div class="row">
                                                <div class="col-md-12">
                                                    <div class="form-group">
                                                        <label for="title">Unit Title</label>
                                                        <input type="text" id="title" class="form-control" placeholder="Enter Unit Title" name="title" value="<?= $data_unit->title ?>">
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="form-group">
                                                <label for="description">Unit Description</label>
                                                <textarea id="description" rows="5" class="form-control" name="description" placeholder="Enter Unit Description"><?= $data_unit->description ?></textarea>
                                            </div>
                                        </div>
