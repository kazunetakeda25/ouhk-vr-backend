                                    ...
                                    <div class="card-body">
                                        ...
                                        <div class="form-body">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input type="text" id="number" class="form-control" placeholder="Enter Unit Number" name="number">
                                            </div>
                                            <div class="row">
                                                <div class="col-md-12">
                                                    <div class="form-group">
                                                        <label for="title">Unit Title</label>
                                                        <input type="text" id="title" class="form-control" placeholder="Enter Unit Title" name="title">
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="form-group">
                                                <label for="description">Unit Description</label>
                                                <textarea id="description" rows="5" class="form-control" name="description" placeholder="Enter Unit Description"></textarea>
                                            </div>
                                        </div>
