    ...
    <div class="main-menu menu-fixed menu-light menu-accordion    menu-shadow " data-scroll-to-active="true"
        ...
        <div class="main-menu-content">
            <ul class="navigation navigation-main" id="main-menu-navigation" data-menu="menu-navigation">
                ...
                <li class=" nav-item active"><a href="<?=base_url()?>sttt"><i class="fa fa-book"></i><span class="menu-title"
                                                ...
                                                <div class="col-md-12">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" id="title" class="form-control"
                                                            placeholder="Enter Answer ST and TT Title" name="title"
                                                            value="<?= $data_sttt->title ?>">
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="form-group">
                                                <label for="original_text">Original Text</label>
                                                <textarea id="original_text" rows="5" class="form-control" name="original_text"
                                                    placeholder="Enter Original Text"><?= $data_sttt->original_text ?></textarea>
                                            </div>
                                            <div class="form-group">
                                                <label for="translated_text">Translated Text</label>
                                                <textarea id="translated_text" rows="5" class="form-control" name="translated_text"
                                                    placeholder="Enter Translated Text"><?= $data_sttt->translated_text ?></textarea>
                                            </div>
                                        </div>
