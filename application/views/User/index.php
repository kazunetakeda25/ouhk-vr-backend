                        ...
                        <div class="col-12">
                            <div class="card">
                                <div class="card-content collapse show">
                                    <div class="card-body">
                                        <a type="button" class="btn btn-success" style="color: white" href="<?= base_url() ?>user/add">
                                            ...
                                            <table class="table table-hover mb-0">
                                                ...
                                                <tbody><?php
                                                        foreach ($data_user as $user) {
                                                            ...
                                                            if ($user->role == 1) {
                                                                echo '<td><span class="badge badge-info ml-1">USER</span></td>';
                                                            } else if ($user->role == 2) {
                                                                echo '<td><span class="badge badge-primary ml-1">ADMIN</span></td>';
                                                            } else if ($user->role == 3) {
                                                                echo '<td><span class="badge badge-danger ml-1">SUPERADMIN</span></td>';
                                                            }
                                                            if ($user->status == 1) {
                                                                echo '<td><span class="badge badge-info ml-1">ACTIVE</span></td>';
                                                            } else if ($user->status == 2) {
                                                                echo '<td><span class="badge badge-danger ml-1">INACTIVE</span></td>';
                                                            } else if ($user->status == 0) {
                                                                echo '<td><span class="badge badge-primary ml-1">PENDING</span></td>';
                                                            }
                                                            ...
                                                            echo '<td style="white-space: nowrap">
                                                                ...
                                                                <a type="button" class="btn btn-danger text-white" href="javascript:deleteUser(' . $user->id . ');"
                                                                    title="Delete">
