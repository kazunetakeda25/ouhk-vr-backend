					...
					<ul class="nav navbar-nav float-right">
						<li class="dropdown dropdown-user nav-item"><a
								...
								<span class="avatar avatar-online"><img
										src="<?=base_url()?>assets/images/ProfileIcon.jpg"
										alt="avatar"></span></a>
							<div class="dropdown-menu dropdown-menu-right">
								<div class="arrow_box_right"><a class="dropdown-item" href="#"><span
											class="avatar avatar-online"><img
												src="<?=base_url()?>assets/images/ProfileIcon.jpg"
												alt="avatar"><span class="user-name text-bold-700 ml-1">Admin</span></span></a>
	...
	<div class="main-menu menu-fixed menu-light menu-accordion    menu-shadow " data-scroll-to-active="true"
		...
		<div class="navbar-header">
			<ul class="nav navbar-nav flex-row">
				<li class="nav-item mr-auto"><a class="navbar-brand" href="index.html"><img class="brand-logo"
							alt="Chameleon admin logo" src="<?=base_url()?>assets/images/VIP_Icon.png" style="width: 52px;" />
		...
		<div class="main-menu-content">
			<ul class="navigation navigation-main" id="main-menu-navigation" data-menu="menu-navigation">
				<li class=" nav-item"><a href="https://themeselection.com/support"><i class="fa fa-desktop" ></i><span
							class="menu-title" data-i18n="">Home</span></a>
				</li>
				<li class=" nav-item"><a href="https://themeselection.com/support"><i class="fa fa-user"></i><span
							class="menu-title" data-i18n="">Users</span></a>
				</li>
				<li class=" nav-item"><a href="https://themeselection.com/support"><i class="fa fa-folder"></i><span
							class="menu-title" data-i18n="">Units</span></a>
				</li>
					...
					<div class="breadcrumbs-top float-md-right">
						<div class="breadcrumb-wrapper mr-1">
							<ol class="breadcrumb">
								...
								<li class="breadcrumb-item"><a href="#">Unit Managment</a>
								</li>
								<li class="breadcrumb-item active"><a href="#">Unit Create</a>
								</li>
							</ol>
						</div>
					</div>
												...
												<tbody>
													<tr>
														...
														<td style='white-space: nowrap'> 
															<a type="button" class="btn btn-secondary text-white" title="Learning Content" >
																<img class="rounded-bottom"
																src="<?=base_url()?>assets/images/LC.png" alt="LC" height="20" width="20">
															</a>     
															<a type="button" class="btn btn-secondary text-white" title="Lecture" >
																<img class="rounded-bottom"
																src="<?=base_url()?>assets/images/LE.png" alt="LE" height="20" width="15">
															</a>   
															<a type="button" class="btn btn-secondary text-white" title="Interpreting Practice and Exercise" >
																<img class="rounded-bottom"
																src="<?=base_url()?>assets/images/IPE.png" alt="IPE" height="20" width="17">
															</a>   
															<a type="button" class="btn btn-secondary text-white" title="Answer ST & TT" >
																<img class="rounded-bottom"
																src="<?=base_url()?>assets/images/STTT.png" alt="STTT" height="20" width="17">
															</a>    
														</td>
														<td  style='white-space: nowrap'> 
															<a type="button" class="btn btn-info text-white" title="Edit">
																<span class="fa fa-edit"></span>
															</a>
															<a type="button" class="btn btn-danger text-white" title="Delete">
