                        ...
                        <div class="col-12">
                            <div class="card">
                                <div class="card-content collapse show">
                                    <div class="card-body">
                                        <?= form_open_multipart(base_url() . 'forum/comment/edit/' . $data_forum_comment->id) ?>
                                        <div class="form-body">
                                            <h4 class="form-section">
                                                <i class="fa fa-folder"></i>Forum Comment Edit
                                            </h4>
                                            <div class="row">
                                                <div class="col-md-12">
                                                    <div class="form-group">
                                                        <label for="title">Shared URL</label>
                                                        <input type="text" id="url" class="form-control" placeholder="Enter Shared URL" name="url" value="<?= $data_forum_comment->url ?>">
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="form-group">
                                                <label for="comment">Comment</label>
                                                <textarea id="comment" rows="5" class="form-control" name="comment" placeholder="Enter Comment"><?= $data_forum_comment->comment ?></textarea>
                                            </div>
                                        </div>
