                                    ...
                                    <div class="card-body">
                                        ...
                                        <div class="form-body">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <textarea id="ex1_answer_original" rows="5" class="form-control" name="ex1_answer_original" placeholder="Enter Exercise 1 Original Answer"><?= $data_sttt->ex1_answer_original ?></textarea>
                                            </div>
                                            <div class="form-group">
                                                <label for="ex1_answer_translated">Ex1. Translated Answer</label>
                                                <textarea id="ex1_answer_translated" rows="5" class="form-control" name="ex1_answer_translated" placeholder="Enter Exercise 2 Translated Answer"><?= $data_sttt->ex1_answer_translated ?></textarea>
                                            </div>

                                            <div class="form-group">
                                                <label for="ex2_answer_original">Ex2. Original Answer</label>
                                                <textarea id="ex2_answer_original" rows="5" class="form-control" name="ex2_answer_original" placeholder="Enter Exercise 2 Original Answer"><?= $data_sttt->ex2_answer_original ?></textarea>
                                            </div>
                                            <div class="form-group">
                                                <label for="ex2_answer_translated">Ex2. Translated Answer</label>
                                                <textarea id="ex2_answer_translated" rows="5" class="form-control" name="ex2_answer_translated" placeholder="Enter Exercise 2 Translated Answer"><?= $data_sttt->ex1_answer_translated ?></textarea>
                                            </div>
                                        </div>
